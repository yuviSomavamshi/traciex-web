...
import { Button, Icon, Grid, TextField, InputAdornment, IconButton, InputLabel, FormControl, OutlinedInput, Snackbar } from "@material-ui/core";
...
class CustomerForm extends Component {
  ...
  render() {
    let { name, contact, password, showPassword, email, country, message, severity, openSnackBar } = this.state;

    return (
      <div className="m-sm-30" style={{ marginTop: "15px" }}>
        <ValidatorForm ref="form" onSubmit={this.handleSubmit} onError={(errors) => null}>
          <Grid container spacing={6}>
            ...
            <Grid item lg={6} md={6} sm={12} xs={12}>
              ...
              <FormControl variant="outlined">
                <InputLabel htmlFor="outlined-adornment-password"> Default Password</InputLabel>
                <OutlinedInput
                  className="mb-16 w-220"
          ...
          <div style={{ float: "right" }}>
            <Button style={{ backgroundColor: "#112855", color: "#ffff" }} variant="contained" type="submit" className="mt-20">
              <Icon>send</Icon>
...
export default withStyles({}, { withTheme: true })(connect(mapStateToProps, { addCustomer })(CustomerForm));
