  ...
  return (
    <div className="m-sm-30">
      <div className="mb-sm-30">
        <Breadcrumb routeSegments={[{ name: "Utilities", path: "/utilities" }, { name: "Spacing" }]} />
      </div>
      <SimpleCard title="Spacing">
        ...
        <h6 className="mb-16 pt-24">
          Example <span className=".font-weight-normal text-muted">[0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48]</span>
        </h6>
