...
function ShoppingCart(props) {
  const { container, theme, settings, cartList = [], getCartList, deleteProductFromCart, updateCartAmount, user } = props;
      ...
      >
        <div className="mini-cart">
          ...
          {cartList.map((product) => (
            <div key={product.id} className="mini-cart__item flex flex-middle flex-space-between py-16 px-8">
              <div className="flex flex-column mr-8">
                <IconButton size="small" onClick={() => updateCartAmount(user.userId, product.id, product.amount + 1)}>
              ...
              <IconButton size="small" onClick={() => deleteProductFromCart(user.userId, product.id)}>
